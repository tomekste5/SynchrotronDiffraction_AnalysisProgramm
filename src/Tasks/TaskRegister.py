...
taskRegister = {
    AzimuthalIntegrationTask.getFuncName(): {
                ...
                "input_params": [Param.getRadSteps,Param.getNptAzim,Param.getRadialRange,Param.getPathToAzimJson,Param.getDirectoryPaths,Param.getProgressBarHandles],
    ...
    VoigtFitTask.getFuncName(): {
                ...
                "input_params": [Param.getMinTheta,Param.getMaxTheta,Param.getDirectoryPaths,Param.getThetaAV,Param.getPeak,Param.getProgressBarHandles],
    ...
    "axisTransform_fit": {
                ...
                "input_params": [Param.getMinTheta,Param.getDirectoryPaths,Param.getWavelength,Param.getPeak,Param.getEModules,Param.getPoissonNumber,Param.getD0,Param.getPositionsZ,Param.getPositionsY,Param.getProgressBarHandles],
