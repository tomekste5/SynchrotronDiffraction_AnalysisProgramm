...
import logging
from Tasks.PseudoVoigtTask import PseudoVoigt_Config
...
class AxisTransformationTask:
    ...
    def runTask(minTheta,directoryPaths,isMultiProcessingAllowed,wavelength,peak,E,Possions,d0,z_val,x_val,handles,funcRet):
        ...
        params = m.dict({"reqFiles":reqFiles,"logger":logger,"returnVal":m.dict({"units":Config.units}),"funcRet":funcRet,"d0":d0,"wavelength":wavelength,"z_val":z_val,"x_val":x_val,"dxxxE":E[peak],"dxxxP":Possions[peak]})
